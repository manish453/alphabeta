...
$(function () {
	$(document).ready(function () {
		...
		$('#addEditPagesForm').on('submit', function (event) {
			...
			$(this).ajaxSubmit({
				...
				success: function (response) {
					...
					let redirectTo = (response.type == 'add') ? '/pages/': ''
		...
		$("body").on('click', '.delete_record', function () {
			...
			delete_records(pageurl + 'delete', { page_id: id }, fetchPages)
		});

		if($('#addEditPagesForm').hasClass('add-page')){
